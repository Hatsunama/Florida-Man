...
local list: { PersonaDef } = {
	...
	},
	{
		...
		skillDescription = "Snap a claw forward — stun + big pinch.",
		skillCooldown = 6,
		skillDamage = 36,
		skillKind = "dash",
	...
	},
	{
		...
		skillDamage = 42,
		skillKind = "aoe",
		unlockHint = "Survive Drive-Thru Disaster.",
	},
	{
		id = "SnakeCharmer",
		name = "Snake Charmer",
		...
		moveSpeed = 19,
		skillName = "Coil Call",
		skillDescription = "Summon a friendly coil that bites once.",
		skillCooldown = 8,
		skillDamage = 30,
		skillKind = "summon",
		unlockHint = "Clear the snake stretch in The Swamp Shift.",
	},
	{
		id = "GolfCartBandit",
		...
		skillDescription = "Dash on cart energy — multi-hit scrape.",
		skillCooldown = 5.5,
		skillDamage = 24,
		skillKind = "dash",
		unlockHint = "Survive Gas Station of Legends with style.",
	},
	{
		...
		skillDamage = 38,
		skillKind = "aoe",
		unlockHint = "Draft chaos items or smash personas at Captain Steve.",
	},
	{
		id = "LizardBreath",
		name = "Lizard Breath",
		...
		skillDescription = "Flame breath beam — melts sludge armor.",
		skillCooldown = 6.5,
		skillDamage = 40,
		skillKind = "beam",
	...
	},
	{
		...
		skillDescription = "Brief shield + heal pulse. Allies rejoice.",
		skillCooldown = 9,
		skillDamage = 18,
		skillKind = "shield",
