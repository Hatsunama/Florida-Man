...
Remotes.Get("ShowNewspaper").OnClientEvent:Connect(function(payload) HUD.CloseMenus(); Newspaper.Show(payload) end)
Remotes.Get("ShowDraft").OnClientEvent:Connect(function(offer) HUD.CloseMenus(); Newspaper.Close(); Draft.Show(offer) end)
Remotes.Get("ShowCredits").OnClientEvent:Connect(function(payload) HUD.CloseMenus(); Credits.Show(payload) end)
...
player.CharacterRemoving:Connect(function() HUD.CloseMenus() end)
